...
describe('Draw Response Of the game:', function () {
    ...
    describe('Draw response', function () {
        ...
        it('should return array of 5 cards with no holded cards', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {}});
        ...
        it('should return array of 5 cards with 2 holded cards', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {'2': 'K_D', '5': '4_A'}});
            expect(response).to.have.property('cards');
            expect(response.cards).to.be.an('Object');
        ...
        it('should return array of 5 cards with 3 holded cards', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {'1': 'J_S', '2': 'K_D', '5': '4_A'}});
            expect(response).to.have.property('cards');
            expect(response.cards).to.be.an('Object');
        ...
        it('should return array of 5 cards with 4 holded cards', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {'1': 'J_S', '2': 'K_D', '4': '6_C', '5': '4_A'}});
            expect(response).to.have.property('cards');
            expect(response.cards).to.be.an('Object');
            expect(response.cards['1']).to.be.equal('J_S');
            expect(response.cards['2']).to.be.equal('K_D');
        ...
        it('should return array of 5 cards with 5 holded cards', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {'1': 'J_S', '2': 'K_D', '3': 'Q_D', '4': 'A_A', '5': '4_A'}});
            expect(response).to.have.property('cards');
            expect(response.cards).to.be.an('Object');
            expect(response.cards['1']).to.be.equal('J_S');
            expect(response.cards['2']).to.be.equal('K_D');
        ...
        it('should return error on duplicate carda', function () {
            var response = api({bet: 10, betLevelIdx: 0, holdedCards: {'1': 'J_S', '2': 'K_D', '3': 'J_S', '4': 'A_A', '5': '4_A'}});
        ...
        it('should return random cards', function () {
            var response1 = api({bet: 10, betLevelIdx: 0});
            var response2 = api({bet: 10, betLevelIdx: 0});
            expect(response1.cards).to.not.eql(response2.cards);

        });
        it('should return bet = bet passes', function () {
            var response = api({bet: 10, betLevelIdx: 0});
        ...
        it('should return win state : HIGH_CARD with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
                holdedCards: {'1': '11_D', '2': '12_D', '3': '13_C', '4': '7_H', '5': '5_C'},
                betLevelIdx: selectedbetLevelIdx
            });
        ...
        it('should return win state : JACKS_OR_BETTER with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['JACKS_OR_BETTER'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('JACKS_OR_BETTER');
            expect(response.win).to.be.equal(bet * winMultipler);


        });
        it('should return win state : TWO_PAIR with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['TWO_PAIR'][selectedbetLevelIdx];
        ...
        it('should return win state : THREE_OF_A_KIND with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['THREE_OF_A_KIND'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('THREE_OF_A_KIND');
            expect(response.win).to.be.equal(bet * winMultipler);


        });
        it('should return win state : STRAIGHT with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['STRAIGHT'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('STRAIGHT');
            expect(response.win).to.be.equal(bet * winMultipler);

        });
        it('should return win state : FLUSH with selectedbetLevelIdx:0 ', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['FLUSH'][selectedbetLevelIdx];
        ...
        it('should return win state : FULL_HOUSE with selectedbetLevelIdx:0', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['FULL_HOUSE'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('FULL_HOUSE');
            expect(response.win).to.be.equal(bet * winMultipler);

        });
        it('should return win state : FOUR_OF_A_KIND with selectedbetLevelIdx:0', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['FOUR_OF_A_KIND'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('FOUR_OF_A_KIND');
            expect(response.win).to.be.equal(bet * winMultipler);


        });
        it('should return win state : STRAIGHT_FLUSH with selectedbetLevelIdx:0', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['STRAIGHT_FLUSH'][selectedbetLevelIdx];
            expect(response.winType).to.be.equal('STRAIGHT_FLUSH');
            expect(response.win).to.be.equal(bet * winMultipler);


        });
        it('should return win state : ROYAL_FLUSH with selectedbetLevelIdx:0', function () {
            var selectedbetLevelIdx = 0;
            var bet = 10;
            var response = api({
                bet: bet,
            ...
            var winMultipler = paytable['ROYAL_FLUSH'][selectedbetLevelIdx];
